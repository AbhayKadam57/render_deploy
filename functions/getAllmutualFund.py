...
def handl_all_MutualFund_data(mutualfund):


    params ={'api_key': f'{API_KEY}', 'url': f'https://groww.in/mutual-funds/{mutualfund}'}
    ...
    for r in holdingTableRow:
       ...
       HoldingTable.append({"name":name,"sector":sector,"instrument":instrument,"assests":assests}) 
    ...
    finalResult =[{"scheme_name":scheme_name,"day_chg":day_chg,"fundamentals":data,"Holdings":HoldingTable,"returns":returnData,"ration":ratioData,"fundmanagers":fundManagerData}]
