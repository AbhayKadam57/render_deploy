...
def handl_stock_details(stock, stock_code):
    ...
    try:
        stock_recomend = soup.select(".update-btn.button.outline-btn.text-uppercase")[
            0
        ].text
    except IndexError:
        stock_recomend = ""
    ...
    results = [
        {
            ...
            "stock_price_chg": stock_price_chg,
            "stock_recomend": stock_recomend,
            "stock_summary": stock_summary,
            "stock_key_indices": stock_key_indices,
            "stock_profitablity_ratio": stock_profitablity_ratio,
            "stock_operation_ratio": stock_operational_ratio,
            "stock_valuation_ratio": stock_valuation_ratio,
